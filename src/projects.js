            ...
            <div>
                ...
                <div className="section" id="projects-div">
                    <Project name="Таблица пользователей" img="Internature1.png"
                        ...
                        редактирования содержимого каждой строки таблицы.</Project>
                    <Project name="Первый одностраничник на React" img="React-Router.png"
                        ...
                        браузера. Благодаря встроенному в Router добавлению активной ссылке класса
                        "active" стилизация становится намного проще, чем на чистом JS или React.</Project>
                </div>
